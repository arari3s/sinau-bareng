...
import 'package:hello_word/materi/MM/DGP.dart';
import 'package:hello_word/materi/MM/PKWU.dart';
import 'package:hello_word/materi/MM/TA2D3D.dart';
...
class XIBDPM extends StatefulWidget {
  @override
  _XIBDPMState createState() => _XIBDPMState();
}

class _XIBDPMState extends State<XIBDPM> {
  @override
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      onTap: () {
                        Navigator.push(context,
                            MaterialPageRoute(builder: (context) => DGP()));
                      },
                      child: Container(
                        height: 70,
                        width: double.infinity,
                  ...
                  // MAPEL TEKNIK ANIMASI 2D DAN 3D
                  SizedBox(
                    height: 10,
                  ),
                  InkWell(
                    onTap: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => TA2D3D()));
                    },
                    child: Container(
                      height: 70,
                      width: double.infinity,
