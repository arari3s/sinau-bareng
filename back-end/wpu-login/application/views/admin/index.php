        ...
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              ...
              <a href="<?= base_url('admin/siswa'); ?>" class="h5 mb-0 font-weight-bold text-gray-800">Siswa</a>
            </div>
            <div class="col-auto">
        ...
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              ...
              <a href="<?= base_url('user/materi'); ?>" class="h5 mb-0 font-weight-bold text-gray-800">Materi</a>
            </div>
            <div class="col-auto">
